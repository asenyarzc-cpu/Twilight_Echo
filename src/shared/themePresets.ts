...
export const BUILT_IN_THEME_PRESETS: readonly ThemeProfileV2[] = Object.freeze([
  ...
  builtInThemePreset(
    'builtin:aurora-reference',
    '暮光档案',
    '暖墨纸面上烫金的收听档案：报头式导航脊、硬边栏线与密排索引，播放页摊开成跨页书脊。',
    {
      pureWhite: {
        'color.primary.500': '#9a6312',
        'color.primary.400': '#b8791c',
        'color.primary.300': '#e5c384',
        'color.primary.rgb': '154, 99, 18',
        'color.accentCyan': '#3f7a6d',
        'color.neutral.50': '#fbf7ef',
        'color.neutral.100': '#f5efe3',
        'color.neutral.200': '#ece3d3',
        'color.neutral.300': '#d9cdb8',
        'color.neutral.500': '#7b7264',
        'color.neutral.700': '#4a4238',
        'color.neutral.900': '#221e2b',
        'surface.app': '#f5efe3',
        'surface.local': '#f5efe3',
        'surface.settings': '#f5efe3',
        'surface.streaming': '#f5efe3',
        'surface.player': '#efe7d8',
        'surface.card': 'rgba(253, 250, 243, 0.86)',
        'surface.cardBorder': 'rgba(154, 99, 18, 0.22)',
        'surface.subtle': '#ece3d3',
        'surface.hover': 'rgba(154, 99, 18, 0.07)',
        'surface.active': 'rgba(154, 99, 18, 0.13)',
        'background.gradientStart': '#faf6ee',
        'background.gradientEnd': '#e9dfca',
        'background.gradientAngle': '168deg',
        'background.coverBlur': '40px',
        'background.overlayOpacity': '14%',
        'shell.control.text': '#221e2b',
        'shell.control.hoverSurface': 'rgba(154, 99, 18, 0.08)',
        'settings.text.primary': '#221e2b',
        'settings.text.muted': '#7b7264',
        'settings.control.surface': '#fbf7ef',
        'settings.control.border': 'rgba(154, 99, 18, 0.2)',
        'settings.panel.border': 'rgba(154, 99, 18, 0.18)',
        'settings.navigation.text': '#7b7264',
        'settings.navigation.hoverSurface': 'rgba(154, 99, 18, 0.06)',
        'settings.navigation.activeSurface': 'rgba(154, 99, 18, 0.12)',
        'navigation.surface': 'rgba(245, 239, 227, 0.96)',
        'navigation.border': 'rgba(154, 99, 18, 0.28)',
        'navigation.shadow': '1px 0 0 rgba(154, 99, 18, 0.14)',
        'navigation.text': '#4a4238',
        'navigation.icon': '#7b7264',
        'navigation.hoverSurface': 'rgba(154, 99, 18, 0.07)',
        'navigation.hoverText': '#221e2b',
        'navigation.activeSurface': 'rgba(154, 99, 18, 0.14)',
        'navigation.activeText': '#7d4f0c',
        'navigation.indicator': '#9a6312',
        'navigation.radius': '0px',
        'navigation.opacity': '96%',
        'library.page.surface':
          'linear-gradient(180deg, rgba(251, 247, 239, 0.92), rgba(233, 223, 202, 0.86))',
        'library.table.surface': 'rgba(251, 247, 239, 0.72)',
        'library.table.border': 'rgba(154, 99, 18, 0.18)',
        'library.table.shadow': '0 1px 0 rgba(154, 99, 18, 0.08)',
        'library.row.text': '#4a4238',
        'library.row.hoverSurface': 'rgba(154, 99, 18, 0.05)',
        'library.selection.surface': 'rgba(154, 99, 18, 0.1)',
        'library.selection.hoverSurface': 'rgba(154, 99, 18, 0.16)',
        'library.selection.indicator': '#9a6312',
        'library.selection.radius': '0px',
        'library.selection.inlineInset': '0px',
        'library.icon': '#7b7264',
        'library.coverRadius': '2px',
        'library.actionRadius': '2px',
        'library.actionSurface': 'rgba(154, 99, 18, 0.1)',
        'library.iconSize': '16px',
        'typography.display': "'Lora', 'MiSans', 'Microsoft YaHei UI', Georgia, serif",
        'typography.rounded': "'JetBrains Mono', 'MiSans', Consolas, monospace",
        'typography.titleWeight': '600',
        'typography.bodyWeight': '400',
        'typography.metaWeight': '500',
        'typography.chromeText': '#4a4238',
        'shape.globalRadius': '3px',
        'shape.cardRadius': '4px',
        'shape.dialogRadius': '3px',
        'shape.searchRadius': '2px',
        'shape.toastRadius': '3px',
        'shape.cardBorderWidth': '1px',
        'material.glass': 'rgba(250, 246, 238, 0.88)',
        'material.glassStrong': 'rgba(251, 247, 239, 0.96)',
        'material.glassBorder': 'rgba(154, 99, 18, 0.2)',
        'material.glassShadow': '0 12px 32px rgba(70, 56, 34, 0.14)',
        'material.glowMain': 'rgba(154, 99, 18, 0.12)',
        'material.glowSoft': 'rgba(63, 122, 109, 0.1)',
        'material.glowCyan': 'rgba(63, 122, 109, 0.12)',
        'material.cardBlur': '16px',
        'material.cardSaturation': '104%',
        'material.surfaceOpacity': '96%',
        'material.trackTitleOpacity': '100%',
        'playback.text.page': '#221e2b',
        'playback.accent': '#9a6312',
        'playback.backdrop.filter': 'blur(56px) saturate(1.08) brightness(1.02)',
        'playback.backdrop.scrim':
          'linear-gradient(180deg, rgba(245, 239, 227, 0.74) 0%, rgba(233, 223, 202, 0.86) 100%)',
        'playback.cover.surface': 'rgba(233, 223, 202, 0.72)',
        'playback.cover.shadow': '0 18px 44px rgba(70, 56, 34, 0.22)',
        'playback.cover.radius': '3px',
        'playback.cover.placeholderText': '#7b7264',
        'playback.track.title': '#221e2b',
        'playback.track.artist': '#5c5346',
        'playback.track.album': '#7b7264',
        'playback.lyrics.text': '#5c5346',
        'playback.lyrics.hoverText': '#221e2b',
        'playback.lyrics.activeText': '#7d4f0c',
        'playback.lyrics.activeSurface': 'rgba(154, 99, 18, 0.1)',
        'playback.lyrics.activeBorder': 'rgba(154, 99, 18, 0.34)',
        'playback.lyrics.activeShadow': '0 0 0 rgba(154, 99, 18, 0)',
        'playback.control.surface': 'rgba(253, 250, 243, 0.72)',
        'playback.control.border': 'rgba(154, 99, 18, 0.24)',
        'playback.control.text': '#221e2b',
        'playback.control.hoverSurface': 'rgba(154, 99, 18, 0.12)',
        'playback.control.hoverBorder': 'rgba(154, 99, 18, 0.44)',
        'playback.control.hoverText': '#7d4f0c',
        'playback.control.hoverShadow': '0 0 0 rgba(154, 99, 18, 0)',
        ...
        'playback.progress.track': 'rgba(154, 99, 18, 0.2)',
        'playback.progress.fill': 'linear-gradient(90deg, #7d4f0c, #cf9330)',
        'playback.progress.height': '8px',
        'playback.progress.radius': '1px',
        'playback.progress.thumbSize': '10px',
        'playback.time.surface': 'rgba(154, 99, 18, 0.1)',
        'playback.time.radius': '2px',
        'playback.time.opacity': '100%',
        'playback.artwork.listRadius': '2px',
        'playback.equalizer.panelSurface': 'rgba(251, 247, 239, 0.92)',
        'playback.equalizer.panelBorder': 'rgba(154, 99, 18, 0.2)',
        'playback.equalizer.panelRadius': '3px',
        'playback.equalizer.sliderTrack': 'rgba(154, 99, 18, 0.18)',
        'playback.equalizer.sliderFill': 'linear-gradient(to top, #7d4f0c, #cf9330)',
        'playback.equalizer.sliderThumb': '#9a6312',
        'playback.equalizer.sliderThumbSize': '14px',
        'playback.equalizer.grid': 'rgba(154, 99, 18, 0.14)',
        'playback.equalizer.guide': 'rgba(154, 99, 18, 0.28)',
        'playback.equalizer.spectrum': '#9a6312',
        'playback.equalizer.knobSize': '14px',
        'playback.equalizer.buttonSurface': 'rgba(154, 99, 18, 0.08)',
        'playback.equalizer.buttonRadius': '2px',
        'motion.enter': 'cubic-bezier(0.05, 0.7, 0.1, 1)',
        'motion.soft': 'cubic-bezier(0.2, 0.8, 0.2, 1)'
      },
      dark: {
        'color.primary.500': '#f0b429',
        'color.primary.400': '#f8cd62',
        'color.primary.300': '#fbe6b0',
        'color.primary.rgb': '240, 180, 41',
        'color.accentCyan': '#7fb0a5',
        'color.neutral.50': '#08070c',
        'color.neutral.100': '#0e0c15',
        'color.neutral.200': '#16131e',
        'color.neutral.300': '#2a2432',
        'color.neutral.500': '#8d8497',
        'color.neutral.700': '#cec5d6',
        'color.neutral.900': '#f7f0e2',
        'surface.app': '#100e17',
        'surface.local': '#100e17',
        'surface.settings': '#100e17',
        'surface.streaming': '#100e17',
        'surface.player': '#0b0910',
        'surface.card': 'rgba(24, 20, 32, 0.78)',
        'surface.cardBorder': 'rgba(240, 180, 41, 0.18)',
        'surface.subtle': '#0c0a12',
        'surface.hover': 'rgba(240, 180, 41, 0.07)',
        'surface.active': 'rgba(240, 180, 41, 0.14)',
        'background.gradientStart': '#191427',
        'background.gradientEnd': '#0d0a12',
        'background.gradientAngle': '168deg',
        'background.coverBlur': '54px',
        'background.overlayOpacity': '52%',
        'shell.control.text': '#f7f0e2',
        'shell.control.hoverSurface': 'rgba(240, 180, 41, 0.1)',
        'settings.text.primary': '#f7f0e2',
        'settings.text.muted': '#8d8497',
        'settings.control.surface': '#16131e',
        'settings.control.border': 'rgba(240, 180, 41, 0.18)',
        'settings.panel.border': 'rgba(240, 180, 41, 0.16)',
        'settings.navigation.text': '#8d8497',
        'settings.navigation.hoverSurface': 'rgba(240, 180, 41, 0.07)',
        'settings.navigation.activeSurface': 'rgba(240, 180, 41, 0.13)',
        'navigation.surface': 'rgba(13, 11, 18, 0.96)',
        'navigation.border': 'rgba(240, 180, 41, 0.2)',
        'navigation.shadow': '1px 0 0 rgba(240, 180, 41, 0.12)',
        'navigation.text': '#cec5d6',
        'navigation.icon': '#8d8497',
        'navigation.hoverSurface': 'rgba(240, 180, 41, 0.08)',
        'navigation.hoverText': '#f7f0e2',
        'navigation.activeSurface': 'rgba(240, 180, 41, 0.15)',
        'navigation.activeText': '#f0b429',
        'navigation.indicator': '#f0b429',
        'navigation.radius': '0px',
        'navigation.opacity': '96%',
        'library.page.surface':
          'linear-gradient(180deg, rgba(20, 16, 27, 0.92), rgba(11, 9, 16, 0.86))',
        'library.table.surface': 'rgba(18, 15, 25, 0.66)',
        'library.table.border': 'rgba(240, 180, 41, 0.16)',
        'library.table.shadow': '0 1px 0 rgba(240, 180, 41, 0.08)',
        'library.row.text': '#cec5d6',
        'library.row.hoverSurface': 'rgba(240, 180, 41, 0.06)',
        'library.selection.surface': 'rgba(240, 180, 41, 0.12)',
        'library.selection.hoverSurface': 'rgba(240, 180, 41, 0.18)',
        'library.selection.indicator': '#f0b429',
        'library.selection.radius': '0px',
        'library.selection.inlineInset': '0px',
        'library.icon': '#8d8497',
        'library.coverRadius': '2px',
        'library.actionRadius': '2px',
        'library.actionSurface': 'rgba(240, 180, 41, 0.12)',
        'library.iconSize': '16px',
        'typography.display': "'Lora', 'MiSans', 'Microsoft YaHei UI', Georgia, serif",
        'typography.rounded': "'JetBrains Mono', 'MiSans', Consolas, monospace",
        'typography.titleWeight': '600',
        ...
        'shape.toastRadius': '3px',
        'shape.cardBorderWidth': '1px',
        'material.glass': 'rgba(18, 15, 25, 0.86)',
        'material.glassStrong': 'rgba(12, 10, 17, 0.95)',
        'material.glassBorder': 'rgba(240, 180, 41, 0.16)',
        'material.glassShadow': '0 16px 42px rgba(0, 0, 0, 0.5)',
        'material.glowMain': 'rgba(240, 180, 41, 0.18)',
        'material.glowSoft': 'rgba(127, 176, 165, 0.12)',
        'material.glowCyan': 'rgba(127, 176, 165, 0.14)',
        'material.cardBlur': '18px',
        'material.cardSaturation': '108%',
        'material.surfaceOpacity': '94%',
        'material.trackTitleOpacity': '100%',
        'playback.text.page': '#f7f0e2',
        'playback.accent': '#f0b429',
        'playback.backdrop.filter': 'blur(64px) saturate(1.2) brightness(0.42)',
        'playback.backdrop.scrim':
          'linear-gradient(180deg, rgba(9, 8, 14, 0.62) 0%, rgba(13, 10, 18, 0.76) 100%)',
        'playback.cover.surface': 'rgba(22, 18, 30, 0.72)',
        'playback.cover.shadow': '0 22px 58px rgba(0, 0, 0, 0.62)',
        'playback.cover.radius': '3px',
        'playback.cover.placeholderText': '#8d8497',
        'playback.track.title': '#f7f0e2',
        'playback.track.artist': '#cec5d6',
        'playback.track.album': '#8d8497',
        'playback.lyrics.text': '#a99fb4',
        'playback.lyrics.hoverText': '#f7f0e2',
        'playback.lyrics.activeText': '#f8cd62',
        'playback.lyrics.activeSurface': 'rgba(240, 180, 41, 0.1)',
        'playback.lyrics.activeBorder': 'rgba(240, 180, 41, 0.32)',
        'playback.lyrics.activeShadow': '0 0 0 rgba(240, 180, 41, 0)',
        'playback.control.surface': 'rgba(24, 20, 32, 0.72)',
        'playback.control.border': 'rgba(240, 180, 41, 0.22)',
        'playback.control.text': '#f7f0e2',
        'playback.control.hoverSurface': 'rgba(240, 180, 41, 0.14)',
        'playback.control.hoverBorder': 'rgba(240, 180, 41, 0.42)',
        'playback.control.hoverText': '#f8cd62',
        'playback.control.hoverShadow': '0 0 0 rgba(240, 180, 41, 0)',
        'playback.control.size': '34px',
        'playback.control.playSize': '44px',
        'playback.control.gap': '8px',
        'playback.control.radius': '2px',
        'playback.control.borderWidth': '1px',
        'playback.progress.track': 'rgba(240, 180, 41, 0.18)',
        'playback.progress.fill': 'linear-gradient(90deg, #8a5a10, #f0b429)',
        'playback.progress.height': '8px',
        'playback.progress.radius': '1px',
        'playback.progress.thumbSize': '10px',
        'playback.time.surface': 'rgba(240, 180, 41, 0.1)',
        'playback.time.radius': '2px',
        'playback.time.opacity': '100%',
        'playback.artwork.listRadius': '2px',
        'playback.equalizer.panelSurface': 'rgba(18, 15, 25, 0.9)',
        'playback.equalizer.panelBorder': 'rgba(240, 180, 41, 0.18)',
        'playback.equalizer.panelRadius': '3px',
        'playback.equalizer.sliderTrack': 'rgba(240, 180, 41, 0.16)',
        'playback.equalizer.sliderFill': 'linear-gradient(to top, #8a5a10, #f0b429)',
        'playback.equalizer.sliderThumb': '#f0b429',
        'playback.equalizer.sliderThumbSize': '14px',
        'playback.equalizer.grid': 'rgba(240, 180, 41, 0.12)',
        'playback.equalizer.guide': 'rgba(240, 180, 41, 0.26)',
        'playback.equalizer.spectrum': '#f0b429',
        'playback.equalizer.knobSize': '14px',
        'playback.equalizer.buttonSurface': 'rgba(240, 180, 41, 0.08)',
        'playback.equalizer.buttonRadius': '2px',
        'motion.enter': 'cubic-bezier(0.05, 0.7, 0.1, 1)',
        'motion.soft': 'cubic-bezier(0.2, 0.8, 0.2, 1)'
      }
